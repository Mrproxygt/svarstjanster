...
:root{
  ...
  --gold:#8f6a1f;--gold-bright:#c49a2e;--gold-soft:rgba(143,106,31,.12);
  --line:#e2d8c4;
...
.tag{display:inline-block;font-size:11px;font-weight:800;color:#6b4f16;border:1px solid rgba(143,106,31,.35);border-radius:99px;padding:4px 11px;margin-bottom:12px;text-transform:uppercase;letter-spacing:.45px;background:#f3e6c8}
...
## Primary pages
- {BASE}/ : Hub comparison of answering service types
- {BASE}/jamfor/ : Side-by-side matrix AI vs human vs callcenter
- {BASE}/ai-receptionist/ : AI receptionist guide
- {BASE}/ai-telefonist/ : AI phone operator guide
- {BASE}/leverantorer/ : Vendor catalog with external links
- {BASE}/svarstjanst-pris/ : Pricing guide
- {BASE}/branscher/ : Industry hub
- {BASE}/guider/ : Decision guides
- {BASE}/faq/ : Short FAQ answers
- {BASE}/alternativ/ : Alternatives to named vendors
- {BASE}/sitemap.xml : Full URL list ({len(urls)} entries)
""",
        encoding="utf-8",
    )
